...
import com.github.yyxff.nexusrpc.client.loadbalancer.LoadBalancerRoundRobin;
...
public class ClientMain {
    ...
    public static void main(String[] args) throws IOException {
        RpcClient rpcClient = new RpcClient(new ServiceMap(), new LoadBalancerRoundRobin());
